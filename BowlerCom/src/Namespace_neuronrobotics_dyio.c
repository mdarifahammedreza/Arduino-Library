...
//            println_E(" Resetting the usb system heartbeat time: ");
//            p_int_E(heartBeatLockTime);
//            println_E(" now: ");
//            p_fl_E(now);
//            println_E(" ms: ");
//            p_fl_E(getMs());
//            println_E(" lastPacket time: ");
//            p_fl_E(getLastPacketTime());
...
boolean neuronRoboticsDyIOProcessor_g(BowlerPacket * Packet) {
   ...
   char * tmpName="arduion";
    ...
    switch (Packet->use.head.RPC) {
        ...
        case _REV:
            Packet->use.data[0] = 3;
            Packet->use.data[1] = 16;
            Packet->use.data[2] = 1;

            Packet->use.data[3] = 3;
			Packet->use.data[4] = 16;
			Packet->use.data[5] = 1;
